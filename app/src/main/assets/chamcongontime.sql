...
CREATE TABLE LeaveRequest (
    ...
    Status VARCHAR(50), -- Đổi từ 'Statuss' thành 'Status' để nhất quán và đúng cú pháp
...
('NV001', 'Nguyễn Vân Anh', '0901234567', 'nva@example.com'),
('NV002', 'Lê Thị Bình', '0902345678', 'ltb@example.com'),
('NV003', 'Trần Văn Cườngng', '0903456789', 'tvc@example.com'),
('NV004', 'Phạm Thị Dung', '0904567890', 'ptd@example.com'),
('NV005', 'Hoàng Văn Ánh', '0905678901', 'hve@example.com'),
...
('NV009', 'Phạm Vân Anh', '0909012345', 'pvi@example.com'),
...
('AT005', '2024-10-01 08:00:00', 'checkin', 'NV003', 'CA001', 'VT002',  16.04590, 108.24151),
('AT006', '2024-10-01 12:00:00', 'checkout', 'NV003', 'CA001', 'VT001',  16.04590, 108.24151),
('AT007', '2024-10-01 13:00:00', 'checkin', 'NV004', 'CA002', 'VT002',  16.04590, 108.24151),
('AT008', '2024-10-01 17:00:00', 'checkout', 'NV004', 'CA002', 'VT001',  16.04590, 108.24151),
...
SELECT * FROM LeaveRequestApproval;
