    ...
    private void handleClick (String key, int value) {
        ...
        if (Position >= 0 && Position < shifts.size()) {
            ...
            if (shift[1].equals(checkTime)) {
                ...
                workDetailCheckinValidTxt.setText(shift[1]);
            } else {
                workDetailCheckinValidTxt.setText("Hợp lệ");
            }
            if (shift[2].equals(checkTime)) {
                workDetailCheckoutLateTxt.setText(shift[2]);
                workDetailCheckoutValidTxt.setText(shift[1]);
            } else {
                workDetailCheckoutValidTxt.setText("Hợp lệ");
            }
        } else {
